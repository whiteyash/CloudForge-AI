...
export default function Sidebar({ currentOrgName = "CloudForge System", userRole = "OWNER" }: SidebarProps) {
  ...
  return (
    <aside
      className={`relative flex flex-col h-screen bg-[#0A1020] border-r border-[#22314D] transition-all duration-300 z-30 ${
        collapsed ? "w-16" : "w-60"
      }`}
    >
      ...
      <div className="flex items-center justify-between h-14 px-4 border-b border-[#22314D] bg-[#111B2E]/50">
        {!collapsed && (
          <Link href="/" className="flex items-center gap-2 font-heading font-bold text-lg text-[#E7EDF7] tracking-tight">
