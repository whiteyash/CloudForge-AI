      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6 max-w-5xl mx-auto w-full">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-heading font-bold text-[#E7EDF7]">Git Provider Connections</h1>
              <p className="text-xs text-[#8B99B8] mt-1">Production OAuth 2.0 connections, rate-limit quotas, granted scopes, and token revocation</p>
            </div>
          ...
          <div className="p-6 rounded-2xl bg-[#111B2E] border border-[#22314D] shadow-lg space-y-3">
            ...
            <div className="space-y-3">
              {connections.map((c) => (
                <div key={c.id} className="p-4 rounded-xl bg-[#0A1020] border border-[#22314D] flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5 pt-1">
                        ...
                        <span className="px-2 py-0.5 rounded text-[10px] font-mono bg-[#16233A] text-[#3DD9C4] border border-[#22314D]">
                          {c.grantedScopes}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-[#16233A] border border-[#22314D] text-[#8B99B8] hover:text-[#F87171] text-xs font-medium flex items-center gap-1 transition-all"
