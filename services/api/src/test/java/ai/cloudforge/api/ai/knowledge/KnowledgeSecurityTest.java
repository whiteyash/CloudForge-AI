...
class KnowledgeSecurityTest {
    ...
    @Test
    void testTenantScopedPostmortemGeneration() {
        ...
        AIResponse<KnowledgeService.PostmortemResponse> response = service.generatePostmortemReport(orgId, userId, projectId, null);
