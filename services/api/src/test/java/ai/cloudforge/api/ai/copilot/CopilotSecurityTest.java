...
class CopilotSecurityTest {
    ...
    @Test
    void testTenantScopedCopilotChat() {
        ...
        AIConversationResponse<CopilotService.CopilotResponse> response = service.processCopilotChat(orgId, userId, projectId, null, "Show similar incidents");
