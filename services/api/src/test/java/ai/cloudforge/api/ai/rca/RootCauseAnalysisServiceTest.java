...
class RootCauseAnalysisServiceTest {
    ...
    @Test
    void testPerformRootCauseAnalysisReturnsAIResponse() {
        ...
        AIResponse<RootCauseAnalysisService.RootCauseReportResponse> response = service.performRootCauseAnalysis(orgId, userId, projectId, incidentId);

        assertNotNull(response);
        assertEquals(98, response.confidence());
